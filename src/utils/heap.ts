...
let _Symbol$iterator: typeof Symbol.iterator;

const _defineProperty = (obj: any, key: PropertyKey, value: any) => {
    if (key in obj) {
...
class Heap {
    heapArray: any;
    _limit: any;
    _invertedCompare: ((a: number, b: number) => 1 | -1 | 0) | undefined;
    /**
     * Alias of add
     */
    ...
    constructor(compare = Heap.minComparator) {
        ...
        _defineProperty(this, "_invertedCompare", (a: any, b: any) => {
   ...
   */
    ...
    static getChildrenIndexOf(idx: number) {
    ...
    static getParentIndexOf(idx: number) {
        if (idx <= 0) {
            return -1;
        }
    ...
    static getSiblingIndexOf(idx: number) {
        if (idx <= 0) {
            return -1;
        }
    ...
    static minComparatorNumber(a: number, b: number) {
        return a - b;
    }
    /**
    ...
    static maxComparatorNumber(a: number, b: number) {
        return b - a;
    }
    /**
    ...
    static defaultIsEqual(a: any, b: any) {
        return a === b;
    }
    /**
     * Prints a heap.
    ...
    static print(heap: { length: number; get: (arg0: number) => any; }) {
   ...
   */
    ...
    static heapify(arr: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
    ...
    static heappop(heapArr: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
    ...
    static heappush(heapArr: any, item: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
        heap.heapArray = heapArr;
        heap.push(item);
    }
    ...
    static heappushpop(heapArr: any, item: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
        heap.heapArray = heapArr;
    ...
    static heapreplace(heapArr: any, item: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
        heap.heapArray = heapArr;
    ...
    static heaptop(heapArr: any, n = 1, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
        heap.heapArray = heapArr;
        return heap.top(n);
    }
    ...
    static heapbottom(heapArr: any, n = 1, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
        heap.heapArray = heapArr;
    ...
    static nlargest(n: number | undefined, iterable: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
    ...
    static nsmallest(n: number | undefined, iterable: any, compare: ((a: any, b: any) => 0 | 1 | -1) | undefined) {
        const heap = new Heap(compare);
        heap.heapArray = [...iterable];
        heap.init();
        return heap.bottom(n);
   ...
   */
    ...
    add(element: { pixelRGB: number[]; isInPixelQueue: boolean; row: number; col: number; tentativeReplacementRGB: number[]; tentativeReplacementDistance: number; }) {
    ...
    check() {
        return this.heapArray.find((el: any, j: any) => !!this.getChildrenOf(j).find((ch) => this.compare(el, ch) > 0));
    }
    /**
    ...
    contains(o: any, fn = Heap.defaultIsEqual) {
        return this.heapArray.findIndex((el: any) => fn(el, o)) >= 0;
    }
    /**
    ...
    remove(o: { pixelRGB: number[]; isInPixelQueue: boolean; row: number; col: number; tentativeReplacementRGB: number[]; tentativeReplacementDistance: number; } | undefined, fn = Heap.defaultIsEqual) {
        if (this.length > 0) {
            if (o === undefined) {
                this.pop();
                return true;
            } else {
                const idx = this.heapArray.findIndex((el: any) => fn(el, o));
    ...
    *[_Symbol$iterator]() {
     ...
     */
    _moveNode(j: string | number, k: number | string) {
    ...
    _sortNodeDown(i: number) {
        ...
        const getPotentialParent = (best: string | number, j: number) => {
